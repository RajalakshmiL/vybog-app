...
import * as StyledDOM from "../../../../component/pages/Candidate-Page/ImportCandidate/style";
import {
  CustomDragAndDrop,
  handleIcon,
  handleFileSelect,
...
function ImportClient() {
  ...
  const handleUpload = () => {
    ...
    if (files.length > 0) {
      navigate("/client-field-mapping");
    }
    console.log("client Import ", files);
  ...
  return (
    <>
      <StyledDOM.StyledHeaderOuterDiv className="header-container">
        <StyledDOM.StyeldHeader2> Import Client</StyledDOM.StyeldHeader2>
